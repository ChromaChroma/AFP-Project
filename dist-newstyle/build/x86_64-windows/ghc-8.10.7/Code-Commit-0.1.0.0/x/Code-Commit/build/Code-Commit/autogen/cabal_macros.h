...
/* package Code-Commit-0.1.0.0 */
#ifndef VERSION_Code_Commit
#define VERSION_Code_Commit "0.1.0.0"
#endif /* VERSION_Code_Commit */
#ifndef MIN_VERSION_Code_Commit
#define MIN_VERSION_Code_Commit(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Code_Commit */
...
#define CURRENT_COMPONENT_ID "Code-Commit-0.1.0.0-inplace-Code-Commit"
